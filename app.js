...
Object.assign(translations.it, {
  [ACCOUNT_STORAGE]: 'Le note di cura e le registrazioni sono conservate nel conto della tua attività, sul server che gestisce, accessibili solo ai suoi membri autenticati, mai a terzi.',
  [ACCOUNT_INVITE]: 'Anteprima dell’invito in attesa salvata nel conto della tua attività. Non viene inviato nulla.'
});
Object.assign(translations.de, {
  [ACCOUNT_STORAGE]: 'Pflegenotizen und Aufnahmen werden im eigenen Geschäftskonto auf dem selbst betriebenen Server gespeichert, nur für angemeldete Mitglieder des Betriebs zugänglich, niemals für Dritte.',
  [ACCOUNT_INVITE]: 'Ausstehende Einladungsvorschau im Geschäftskonto gespeichert. Es wird nichts versendet.'
});
Object.assign(translations.es, {
  [ACCOUNT_STORAGE]: 'Las notas de cuidado y grabaciones se guardan en la cuenta de tu negocio, en el servidor que administra, accesibles solo para sus miembros con sesión iniciada, nunca para terceros.',
  [ACCOUNT_INVITE]: 'Vista previa de invitación pendiente guardada en la cuenta de tu negocio. No se envía nada.'
});
function storageCopy(browserCopy, accountCopy = ACCOUNT_STORAGE) {
  return t(window.DogCareAPI ? accountCopy : browserCopy);
}
...
Object.assign(translations.it, {
  Handoff:'Passaggio', 'CARE CONTINUITY · TODAY':'CONTINUITÀ DELLE CURE · OGGI', 'A clear handoff for whoever cares next':'Un passaggio chiaro per chi si prende cura dopo',
  "Built from today's captured observations. Review before sharing or starting care.":'Creato dalle osservazioni registrate oggi. Controlla prima di condividere o iniziare le cure.',
  'Handoff audience':'Destinatario del passaggio', 'Next carer':'Prossimo assistente', '{count} observations today':'{count} osservazioni oggi',
  'Prepared for {audience}':'Preparato per {audience}', "{name}'s care highlights":'Punti salienti delle cure di {name}',
  '{count} captured moments · last update {time}':'{count} momenti registrati · ultimo aggiornamento {time}', 'not yet recorded':'non ancora registrato',
  'No observations captured today yet. Add a care moment before handoff.':'Nessuna osservazione registrata oggi. Aggiungi un momento di cura prima del passaggio.',
  'Health observation — factual, not diagnostic':'Osservazione sanitaria — fattuale, non diagnostica', 'Health context':'Contesto sanitario',
  'NEXT CARE':'PROSSIME CURE', 'What to do next':'Cosa fare dopo', '＋ Add follow-up observation':'＋ Aggiungi osservazione di follow-up',
  'Evidence for this handoff':'Prove per questo passaggio', "Open any source observation in {name}'s care timeline.":'Apri qualsiasi osservazione di origine nella cronologia delle cure di {name}.',
  'Review owner story':'Rivedi il racconto per il proprietario', "View today's gallery":'Vedi la galleria di oggi', 'View source →':'Vedi origine →',
  'No source observations available yet.':'Nessuna osservazione di origine disponibile.',
  'Food and drink: {text}':'Cibo e bevande: {text}', 'Movement and enrichment: {text}':'Movimento e arricchimento: {text}',
  '{count} factual health observation is linked below. This is not a diagnosis; keep observing and contact a veterinarian if you are concerned.':'{count} osservazione sanitaria fattuale è collegata di seguito. Non è una diagnosi; continua a osservare e contatta un veterinario in caso di dubbi.',
  '{count} factual health observations are linked below. This is not a diagnosis; keep observing and contact a veterinarian if you are concerned.':'{count} osservazioni sanitarie fattuali sono collegate di seguito. Non è una diagnosi; continua a osservare e contatta un veterinario in caso di dubbi.',
  "No health-watch observations were recorded today. This reflects today's care log, not a clinical assessment.":'Oggi non sono state registrate osservazioni sanitarie da monitorare. Questo riflette il diario di cura di oggi, non una valutazione clinica.',
  'Continue to observe the specific signs noted below.':'Continua a osservare i segni specifici indicati di seguito.',
  'Share any change or concern with the next carer, and contact your veterinarian if concerned.':'Condividi ogni cambiamento o preoccupazione con il prossimo assistente e contatta il veterinario in caso di dubbi.',
  'Keep the usual home routine for food, rest and movement.':'Mantieni la solita routine domestica per cibo, riposo e movimento.',
  'Share any change that could help the next carer.':'Condividi ogni cambiamento che potrebbe aiutare il prossimo assistente.',
  'Read the linked observations before care starts.':'Leggi le osservazioni collegate prima di iniziare le cure.',
  'Observe and record any change using factual language; contact the owner and veterinarian if concerned.':'Osserva e registra ogni cambiamento con linguaggio fattuale; contatta il proprietario e il veterinario in caso di dubbi.',
  'Follow the owner-confirmed food, movement and rest routine.':'Segui la routine di cibo, movimento e riposo confermata dal proprietario.',
  'Add the next useful observation so the owner has a continuous record.':'Aggiungi la prossima osservazione utile così il proprietario ha un registro continuo.'
});
Object.assign(translations.de, {
  Handoff:'Übergabe', 'CARE CONTINUITY · TODAY':'PFLEGEKONTINUITÄT · HEUTE', 'A clear handoff for whoever cares next':'Eine klare Übergabe für die nächste betreuende Person',
  "Built from today's captured observations. Review before sharing or starting care.":'Erstellt aus den heute erfassten Beobachtungen. Vor dem Teilen oder Pflegebeginn prüfen.',
  'Handoff audience':'Empfänger der Übergabe', 'Next carer':'Nächste Betreuung', '{count} observations today':'{count} Beobachtungen heute',
  'Prepared for {audience}':'Vorbereitet für {audience}', "{name}'s care highlights":'Pflege-Höhepunkte von {name}',
  '{count} captured moments · last update {time}':'{count} erfasste Momente · letzte Aktualisierung {time}', 'not yet recorded':'noch nicht erfasst',
  'No observations captured today yet. Add a care moment before handoff.':'Heute noch keine Beobachtungen erfasst. Fügen Sie vor der Übergabe einen Pflegemoment hinzu.',
  'Health observation — factual, not diagnostic':'Gesundheitsbeobachtung — sachlich, keine Diagnose', 'Health context':'Gesundheitskontext',
  'NEXT CARE':'NÄCHSTE PFLEGE', 'What to do next':'Was als Nächstes zu tun ist', '＋ Add follow-up observation':'＋ Folgebeobachtung hinzufügen',
  'Evidence for this handoff':'Belege für diese Übergabe', "Open any source observation in {name}'s care timeline.":'Öffnen Sie jede Quellbeobachtung in der Pflege-Chronik von {name}.',
  'Review owner story':'Besitzer-Story ansehen', "View today's gallery":'Heutige Galerie ansehen', 'View source →':'Quelle ansehen →',
  'No source observations available yet.':'Noch keine Quellbeobachtungen verfügbar.',
  'Food and drink: {text}':'Essen und Trinken: {text}', 'Movement and enrichment: {text}':'Bewegung und Beschäftigung: {text}',
  '{count} factual health observation is linked below. This is not a diagnosis; keep observing and contact a veterinarian if you are concerned.':'{count} sachliche Gesundheitsbeobachtung ist unten verknüpft. Dies ist keine Diagnose; beobachten Sie weiter und kontaktieren Sie bei Sorge einen Tierarzt.',
  '{count} factual health observations are linked below. This is not a diagnosis; keep observing and contact a veterinarian if you are concerned.':'{count} sachliche Gesundheitsbeobachtungen sind unten verknüpft. Dies ist keine Diagnose; beobachten Sie weiter und kontaktieren Sie bei Sorge einen Tierarzt.',
  "No health-watch observations were recorded today. This reflects today's care log, not a clinical assessment.":'Heute wurden keine zu beobachtenden Gesundheitsnotizen erfasst. Dies spiegelt das heutige Pflegeprotokoll wider, keine klinische Beurteilung.',
  'Continue to observe the specific signs noted below.':'Beobachten Sie weiterhin die unten genannten spezifischen Anzeichen.',
  'Share any change or concern with the next carer, and contact your veterinarian if concerned.':'Teilen Sie jede Veränderung oder Sorge mit der nächsten Betreuung und kontaktieren Sie bei Sorge Ihren Tierarzt.',
  'Keep the usual home routine for food, rest and movement.':'Behalten Sie die übliche häusliche Routine für Futter, Ruhe und Bewegung bei.',
  'Share any change that could help the next carer.':'Teilen Sie jede Veränderung, die der nächsten Betreuung helfen könnte.',
  'Read the linked observations before care starts.':'Lesen Sie die verknüpften Beobachtungen vor Pflegebeginn.',
  'Observe and record any change using factual language; contact the owner and veterinarian if concerned.':'Beobachten und notieren Sie jede Veränderung in sachlicher Sprache; kontaktieren Sie bei Sorge Besitzer und Tierarzt.',
  'Follow the owner-confirmed food, movement and rest routine.':'Folgen Sie der vom Besitzer bestätigten Futter-, Bewegungs- und Ruheroutine.',
  'Add the next useful observation so the owner has a continuous record.':'Fügen Sie die nächste nützliche Beobachtung hinzu, damit der Besitzer einen durchgängigen Verlauf hat.'
});
Object.assign(translations.es, {
  Handoff:'Relevo', 'CARE CONTINUITY · TODAY':'CONTINUIDAD DEL CUIDADO · HOY', 'A clear handoff for whoever cares next':'Un relevo claro para quien cuide a continuación',
  "Built from today's captured observations. Review before sharing or starting care.":'Creado a partir de las observaciones registradas hoy. Revisa antes de compartir o empezar el cuidado.',
  'Handoff audience':'Destinatario del relevo', 'Next carer':'Próximo cuidador', '{count} observations today':'{count} observaciones hoy',
  'Prepared for {audience}':'Preparado para {audience}', "{name}'s care highlights":'Puntos clave del cuidado de {name}',
  '{count} captured moments · last update {time}':'{count} momentos registrados · última actualización {time}', 'not yet recorded':'aún no registrada',
  'No observations captured today yet. Add a care moment before handoff.':'Aún no hay observaciones registradas hoy. Añade un momento de cuidado antes del relevo.',
  'Health observation — factual, not diagnostic':'Observación de salud — objetiva, no diagnóstica', 'Health context':'Contexto de salud',
  'NEXT CARE':'PRÓXIMO CUIDADO', 'What to do next':'Qué hacer a continuación', '＋ Add follow-up observation':'＋ Añadir observación de seguimiento',
  'Evidence for this handoff':'Pruebas para este relevo', "Open any source observation in {name}'s care timeline.":'Abre cualquier observación de origen en el historial de cuidado de {name}.',
  'Review owner story':'Revisar el relato del dueño', "View today's gallery":'Ver la galería de hoy', 'View source →':'Ver origen →',
  'No source observations available yet.':'Aún no hay observaciones de origen disponibles.',
  'Food and drink: {text}':'Comida y bebida: {text}', 'Movement and enrichment: {text}':'Movimiento y enriquecimiento: {text}',
  '{count} factual health observation is linked below. This is not a diagnosis; keep observing and contact a veterinarian if you are concerned.':'{count} observación de salud objetiva está enlazada abajo. No es un diagnóstico; sigue observando y contacta con un veterinario si te preocupa.',
  '{count} factual health observations are linked below. This is not a diagnosis; keep observing and contact a veterinarian if you are concerned.':'{count} observaciones de salud objetivas están enlazadas abajo. No es un diagnóstico; sigue observando y contacta con un veterinario si te preocupa.',
  "No health-watch observations were recorded today. This reflects today's care log, not a clinical assessment.":'Hoy no se registraron observaciones de salud que vigilar. Esto refleja el registro de cuidado de hoy, no una evaluación clínica.',
  'Continue to observe the specific signs noted below.':'Sigue observando los signos específicos indicados abajo.',
  'Share any change or concern with the next carer, and contact your veterinarian if concerned.':'Comparte cualquier cambio o preocupación con el próximo cuidador y contacta con tu veterinario si te preocupa.',
  'Keep the usual home routine for food, rest and movement.':'Mantén la rutina habitual en casa para comida, descanso y movimiento.',
  'Share any change that could help the next carer.':'Comparte cualquier cambio que pueda ayudar al próximo cuidador.',
  'Read the linked observations before care starts.':'Lee las observaciones enlazadas antes de empezar el cuidado.',
  'Observe and record any change using factual language; contact the owner and veterinarian if concerned.':'Observa y registra cualquier cambio con lenguaje objetivo; contacta con el dueño y el veterinario si te preocupa.',
  'Follow the owner-confirmed food, movement and rest routine.':'Sigue la rutina de comida, movimiento y descanso confirmada por el dueño.',
...
function handoffSummary(key) {
  ...
  const nutrition=observations.find(o=>hasTag(o,/nutrition/i)), activity=observations.find(o=>hasTag(o,/activity|exercise|walk|social/i));
  const highlights=[];
  if(nutrition) highlights.push(tf('Food and drink: {text}', {text:t(nutrition.text)}));
  if(activity) highlights.push(tf('Movement and enrichment: {text}', {text:t(activity.text)}));
  observations.filter(o=>!highlights.some(text=>text.includes(t(o.text)))).slice(0,Math.max(0,3-highlights.length)).forEach(o=>highlights.push(t(o.text)));
  const healthText=health.length
    ? tf(health.length===1?'{count} factual health observation is linked below. This is not a diagnosis; keep observing and contact a veterinarian if you are concerned.':'{count} factual health observations are linked below. This is not a diagnosis; keep observing and contact a veterinarian if you are concerned.', {count:health.length})
    : t('No health-watch observations were recorded today. This reflects today\'s care log, not a clinical assessment.');
  const guidance=state.handoffAudience==='owner'
    ? (health.length ? [t('Continue to observe the specific signs noted below.'), t('Share any change or concern with the next carer, and contact your veterinarian if concerned.')] : [t('Keep the usual home routine for food, rest and movement.'), t('Share any change that could help the next carer.')])
    : (health.length ? [t('Read the linked observations before care starts.'), t('Observe and record any change using factual language; contact the owner and veterinarian if concerned.')] : [t('Follow the owner-confirmed food, movement and rest routine.'), t('Add the next useful observation so the owner has a continuous record.')]);
...
function assistantReply(prompt,intent) {
  ...
  if(intent==='attention'||/attention|health|unusual|concern|surveiller|santé|inhabituel|inqui|aufmerksamkeit|gesundheit|ungewöhnlich|sorge/.test(lower)) {
  ...
  if(intent==='handoff'||/handoff|owner|report|story|relais|propriétaire|récit|übergabe|besitzer|bericht|geschichte/.test(lower)) return assistantText().handoff;
  if(intent==='brief'||/schedule|today|next|brief|journée|résume|programme|suite|heute|nächste|zusammenfass|programm/.test(lower)) return assistantBriefing();
  if(/note|record|capture|journal|notiz|aufnahme|aufzeichn/.test(lower)) return assistantText().capture;
...
function appendAssistantExchange(prompt,response) {
  const thread=document.querySelector('#assistant-thread'),copy=assistantText();
  thread.insertAdjacentHTML('beforeend',`<div class="assistant-message you"><span>${copy.you}</span><p>${escapeHtml(prompt)}</p></div><div class="assistant-message muse"><span>${copy.muse}</span><p>${escapeHtml(response)}</p></div>`);
...
const views = {
  ...
  handoff() {
    ...
    return `<div class="handoff-heading"><div><p class="eyebrow">${t('CARE CONTINUITY · TODAY')}</p><h2>${t('A clear handoff for whoever cares next')}</h2><p>${t('Built from today\'s captured observations. Review before sharing or starting care.')}</p></div><div class="audience-toggle" aria-label="${t('Handoff audience')}"><button class="${state.handoffAudience==='owner'?'active':''}" data-audience="owner">${t('Owner')}</button><button class="${state.handoffAudience==='carer'?'active':''}" data-audience="carer">${t('Next carer')}</button></div></div>
      ...
      <section class="card evidence-panel"><div class="section-head"><div><h2>${t('Evidence for this handoff')}</h2><p>${tf("Open any source observation in {name}'s care timeline.", {name:d.name.split(' ')[0]})}</p></div><div><button class="link-button" data-go="story">${t('Review owner story')}</button><button class="ghost" data-go="gallery">${t("View today's gallery")}</button></div></div><div class="evidence-list">${summary.observations.length?summary.observations.map(o=>`<button class="evidence-row" data-evidence-dog="${key}" data-evidence-id="${o.id}"><time>${o.time}</time><span><strong>${escapeHtml(t(o.title))}</strong><small>${escapeHtml(t(o.text))}</small></span><b>${t('View source →')}</b></button>`).join(''):`<p class="empty-evidence">${t('No source observations available yet.')}</p>`}</div></section>`;
  },
...
function bindView() {
  ...
  document.querySelectorAll('[data-handoff-dog]').forEach(el=>el.onclick=()=>{state.dog=el.dataset.handoffDog;navigate('handoff')});
  document.querySelectorAll('[data-audience]').forEach(el=>el.onclick=()=>{state.handoffAudience=el.dataset.audience;navigate('handoff')});
